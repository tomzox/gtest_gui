...
class Config_dialog(object):
    def __init__(self, tk_top):
        ...
        self.__add_entry_widget(3, "Valgrind command line:", self.var_cfg_valgrind1, "config.valgrind1")
        self.__add_entry_widget(4, "Valgrind alternate:", self.var_cfg_valgrind2, "config.valgrind2")
        self.__add_checkbutton(5, "Valgrind supports --error-exitcode",
