...
# "compat" := oldest version of gtrunner that can parse this file
...
def get_rc_file_path():
    if (os.name == "posix"):
        ...
        if xdg_config_home is not None and os.path.exists(xdg_config_home):
            rc_file = os.path.join(xdg_config_home, "gtrunner", "gtrunner.rc")

        elif home is not None and os.path.exists(home):
            config_dir = os.path.join(home, ".config")
            if os.path.exists(config_dir) and os.path.isdir(config_dir):
                rc_file = os.path.join(home, ".config", "gtrunner", "gtrunner.rc")
            else:
                rc_file = os.path.join(home, ".gtrunner.rc")
